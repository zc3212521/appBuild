...
import { PRO_REQUEST,PRO_BASE } from '../upload/util';
...
class GroupUpload extends Component {
  ...
  getPfopPictures(pictures){
    PRO_REQUEST.ajax.fetchData(this.props.uploadConfig.WANGSU_PFOP, {
      "list": pictures
    }, (data) => {
      ...
      <span>
        ...
        <Modal
          title={<span> <span>上传水印图片</span> &nbsp;
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;{
              this.props.atuoSize
              ?<Checkbox style={{display:'none'}} onChange={this.onAutoSizeChange} defaultChecked={this.state.isAutoSize}>按照图片{this.props.atuoSize[0]==0?"高度":"宽度"}自动缩放到{this.props.atuoSize[0]||"[自动]"}*{this.props.atuoSize[1]||"[自动]"}</Checkbox>
              :null
            }
        </span>}
